...
#To understand what the shorthand operators do and why Python includes them, 
# imagine a program that computes the price of a pizza. The price of a large pizza with cheese and no other toppings is $10.95. 
# The price of each topping, such as ham, pepperoni, olives, and pineapple is $1.45. 
# Here is a short example program that asks the user for the number of toppings and computes the price of a pizza:
...
number_of_toppings = int(input("How many toppings do you need? "))
# Compute the cost of the toppings.
price_per_topping = 1.45
topping_cost = price_per_topping * number_of_toppings
...
# Consider the program in this example 
#  that gets a string of text from a user 
# and prints the number of characters in the string 
# and prints the string in all upper case characters.

# Get a string of text from the user.
text1 = input("Enter a short quote: ")
